    ...
    export class LevelPreset extends outrun.Stage
    {
        ...
        ***************************************************************************************************************/
        ...
        protected createRoad( playerZ:number ) : outrun.Segment[]
        {
            ...
            stageBuilder.addCurve(                 outrun.SettingColor.DEFAULT, outrun.RoadLength.MEDIUM, outrun.RoadCurve.MEDIUM, outrun.Road.HILL.LOW);
            stageBuilder.addBumpsLegacy(           outrun.SettingColor.DEFAULT );
            stageBuilder.addLowRollingHillsLegacy( outrun.SettingColor.DEFAULT, outrun.RoadLength.SHORT, outrun.Road.HILL.LOW );
            stageBuilder.addCurve(                 outrun.SettingColor.DEFAULT, outrun.RoadLength.LONG * 2, outrun.RoadCurve.MEDIUM, outrun.Road.HILL.MEDIUM);
            ...
            stageBuilder.addSCurvesLegacy(         outrun.SettingColor.DEFAULT );
            stageBuilder.addCurve(                 outrun.SettingColor.DEFAULT, outrun.RoadLength.LONG, -outrun.RoadCurve.MEDIUM, outrun.Road.HILL.NONE);
            stageBuilder.addHill(                  outrun.SettingColor.DEFAULT, outrun.RoadLength.LONG, outrun.Road.HILL.HIGH);
            stageBuilder.addCurve(                 outrun.SettingColor.DEFAULT, outrun.RoadLength.LONG, outrun.RoadCurve.MEDIUM, -outrun.Road.HILL.LOW);
            stageBuilder.addBumpsLegacy(           outrun.SettingColor.DEFAULT );
