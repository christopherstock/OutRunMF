    ...
    export class LevelPreset extends outrun.Stage
    {
        ...
        ***************************************************************************************************************/
        ...
        protected createRoad( playerZ:number ) : void
        {
            ...
            outrun.StageBuilder.addStraight(        this.segments, outrun.Road.LENGTH.SHORT );
            ...
            outrun.StageBuilder.addCurve(           this.segments, outrun.Road.LENGTH.MEDIUM, outrun.Road.CURVE.MEDIUM, outrun.Road.HILL.LOW);
